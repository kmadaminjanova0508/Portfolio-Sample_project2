...
const Contact = () => {
  ...
  <div className='flex flex-col w-full max-w-[700px] '>
   ...
   className='h2 text-center mb-12'>
    Lets <span className='text-accent'>connect.</span></motion.h2>
    {/* from */}
    <motion.form
    ...
    className='flex-1 flex flex-col gap-6 w-full mx-auto'>
     ...
     overflow-hidden hover:border-accent group'>
      ...
      <BsArrowRight className='-translate-y-[120%] opacity-0 transition-all text-[22px] group-hover:opacity-100 duration-300 group-hover:flex group-hover:-translate-y-0 absolute'/>
     </button>
    </motion.form>
  </div>
  </div>
